...
class IndexController {
	...
	// 获取新闻信息
	@RequestMapping(value = "index/getNews", method = RequestMethod.GET, produces = "text/html;charset=utf-8")
	@ResponseBody
	...
	// 获取最新音乐列表
	@RequestMapping(value = "index/getMusic", method = RequestMethod.GET, produces = "text/html;charset=utf-8")
	@ResponseBody
	...
	// 获取音乐排名列表
	@RequestMapping(value = "index/getRank/{data}", method = RequestMethod.GET, produces = "text/html;charset=utf-8")
	@ResponseBody
	...
	// 根据音乐id获取详细音乐信息
	@RequestMapping(value = "index/getMInfo/{id}", method = RequestMethod.GET, produces = "text/html;charset=utf-8")
	@ResponseBody
	...
	// 根据音乐链接获取详细音乐信息
	@RequestMapping(value = "index/getMSrc/**", method = RequestMethod.GET, produces = "text/html;charset=utf-8")
	@ResponseBody
	...
	// 收藏音乐
	@RequestMapping(value = "index/colMusic/mid={mid}uid={uid}", method = RequestMethod.GET, produces = "text/html;charset=utf-8")
	@ResponseBody
