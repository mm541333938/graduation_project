...
!function(a, b) {
	...
	function m(a, b) {
		if (!a) return "";
		a = h(a), a = i(a), a = h(a), a = j(a), a = h(a), a = g(a), a = h(a);var c = l(a, b);
		return c = h(c), c = k(c)
	}
	function n(a) {
	...
	if (!a.seajs) {
		...
		var L = "undefined" == typeof window && "undefined" != typeof importScripts && z(importScripts),
			...
			N,
			O,
			P = !location.href || M.test(location.href) ? "" : e(location.href);
		if (L) {
			var Q;
			try {
				var R = Error();
		...
		t.prototype.resolve = function() {
			...
			function a(b) {
				...
				if (d.status == ib.ERROR)
					throw Error("module was broken: " + d.uri);
				return d.exec()
			}
			var c = this;
			if (c.status >= ib.EXECUTING) return c.exports;
			if (c.status = ib.EXECUTING, c._entry && !c._entry.length &&
				delete c._entry
				, !c.hasOwnProperty("factory")) return c.non = !0, b;
			var e = c.uri;
			...
			return g === b && (g = c.exports),
				delete c.factory
				, c.exports = g, c.status = ib.EXECUTED, C("exec", c), c.exports
			...
			function d(a) {
				delete fb[h]
				, gb[h] = !0, eb && (t.save(f, eb), eb = null);var b,
					c = hb[h];
				for (
					delete hb[h];
					b = c.shift();) a === !0 ? b.error() : b.load()
			}
			var e = this,
				f = e.uri;
