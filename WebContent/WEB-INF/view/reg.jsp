...
<div class="wrap">
	<div class="wrap-in">
		<form:form method="POST" action="/CloudMusic/userRegister" commandName="register" >
	    	<div class="title">
	    		<h3>邮箱注册</h3>
	    	</div>
	        <div class="text text-top">
	        	昵称
	            <form:input type="text" path="name" placeholder="昵称"/>
	        </div>
            <div class="text">
            	邮箱
	        ...
	        <div class="text">
	        	登录密码
	            <form:input type="password" path="pwd" placeholder="登录密码（6-16位）"/>
	        </div>
             <div class="text">
             	确认密码
                <form:input type="password" path="repwd" placeholder="确认密码"/>
            </div>
	        <div class="tips">
	        	${register_status}
	        </div>
