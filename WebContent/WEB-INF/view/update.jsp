		...
		<div class="header-center center">
			...
			<div class="top-tool">
				<div class="top-search">
					<i class="icn-search"></i> <input type="text"
...
<div class="wrap" style="overflow: hidden">
	<div class="wrap-in">
		<form:form method="GET" action="/CloudMusic/userUpdate" commandName="user" >
		     <div class="text text-top" style="margin-top: 30px;">
	        	昵称
	            <input type="text" name="name" placeholder="昵称" style="width: 100%;
	height: 28px;
	text-indent: 5px;
	border: solid 1px #cdcdcd;"/>
	        ...
	        <div class="submit">
	        	<input type="submit" value="修改" style="width: 100%;
	height: 30px;
	color: #fff;
	letter-spacing: 10px;
	margin: 10px auto;
	...
	border-radius: 4px;
	background: #2273C2;
	background: linear-gradient(rgba(65,145,218,1),rgba(37,118,200,1));">
	        </div>
	...
	<div class="footer">
		<div class="footer-center">
			<a class="recruit" href="javascript:;">
				<p>独立音乐人招募计划</p> <span>加入我们 即将与超过亿万乐迷互动</span>
			</a>
			<div class="copy">
				<ul class="copy-list">
	...
	<div class="fix-bottom">
		<div class="fix-lock">
			<div class="lock-img">
				<a href="javascript:;" class="unlock"></a>
			</div>
		</div>
		<div class="fix-play">
			<div class="play-btns" id="play-btns">
				<a href="javascript:;" class="prv" title="上一首"></a> <a
					href="javascript:;" id="data-ps" class="ply" title="播放">
					<!--.pas-->
				</a> <a href="javascript:;" class="nxt" title="下一首"></a>
			</div>
			<div class="play-head">
			...
			<div class="play-ing" id="play-ing">
				<div class="ptitle">
					<a href="#" class="title" title="曲名"></a> <a href="#"
						class="singer" title="演绎者"></a>
				</div>
				<div class="pbar">
					<div class="barbg">
						<!-- 总进度条 -->
						...
						<div class="cur">
							...
							'
							<!-- <span class="btn-cur" id="data-cur"><i><!-- loading... -->
							</i></span> -->
						</div>
					</div>
			...
			<div class="play-oper" id="play-oper">
				<a href="javascript:;" class="icon-colle" title="收藏"></a> <a
					href="javascript:;" class="icon-share" title="分享"></a>
			</div>
			<div class="play-form">
				<div class="form-title">
					<h3>播放列表</h3>
					<a href="javascript:;" class="icon-colle"><span></span>收藏全部</a> <span>|</span>
					<a href="javascript:;" class="icon-empty"><span></span>清空</a> <a
						href="javascript:;" class="table-close" title="关闭"></a>
				</div>
			...
			<div class="play-ctrl" id="play-ctrl">
				...
				<a href="javascript:;" class="icon-vol" title="音量"></a> <a
					href="javascript:;" class="icon-loop" id="data-lop" title="循环"></a>
				<div class="lp-tip">单曲循环</div>
				<span class="music-list"> <a href="javascript:;"
					class="icon-list" title="播放列表">0</a> <em>已添加到播放列表</em>
				</span>
			</div>
